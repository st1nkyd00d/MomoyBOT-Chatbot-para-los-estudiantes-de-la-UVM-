...
function LandingPage () {
    return(
        ...
        <Nav/>
            <section className="bg-principal p-3 bg-cover bg-fixed md:h-[100vh] lg:bg-principalHorizontal lg:h-[80vh] ">
                <h1 className="text-white font-signikaNegative text-5xl flex pt-96 px-3 md:text-7xl md:pt-[55vh] lg:pt-[45vh] xl:pt-80 2xl:pt-[40vh] ur:mt-[3vh]">MomoyBot</h1>
        ...
        <section className=" p-5">
            <h1 className="text-center text-textColor font-signikaNegative shadow- text-4xl mt-5 mb-5 md:text-6xl 2xl:text-7xl" >¿Por qué usarlo?</h1>
        
            <div className="flex flex-col items-center w-full mb-5 lg:flex-row lg:flex-wrap lg:justify-center">
        
                <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-80 duration-300 flex justify-center font-Urbanist text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor md:text-2xl md:w-[90%] md:p-7 lg:w-[40%] lg:text-xl lg:mr-7 2xl:text-3xl ur:text-4xl">
                ...
                <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-80 duration-300 flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor md:text-2xl  md:w-[90%] md:p-7 lg:w-[45%] lg:text-xl 2xl:text-3xl 2xl:w-[50%] ur:text-4xl">
                ...
                <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-80 duration-300 flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor md:text-2xl  md:w-[90%] md:p-7 lg:w-[40%] lg:text-xl lg:mr-7 2xl:text-3xl ur:text-4xl">
                ...
                <div className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-80 duration-300 flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor md:text-2xl  md:w-[90%] md:p-7 lg:w-[48%] lg:text-xl 2xl:text-3xl 2xl:w-[50%] ur:text-4xl">
        ...
        <div>
            <p className="font-signikaNegative text-textColor text-center text-3xl p-7 md:text-5xl 2xl:text-6xl ur:text-7xl">¡Tener respuestas a tus preguntas nunca fue tan fácil!</p>
            <Carrusel/>
        </div>
